  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4",
        month_caption: "flex justify-center relative items-center h-8 px-10",
        ...
        button_previous: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute left-1 inset-y-0 my-auto"
        ),
        button_next: cn(
          buttonVariants({ variant: "ghost" }),
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute right-1 inset-y-0 my-auto"
        ),
        ...
        day_button: cn(
          buttonVariants({ variant: "ghost" }),
          "h-8 w-8 p-0 font-normal aria-selected:opacity-100 transition-none"
        ),
      ...
      components={{
        ...
        Dropdown: ({ value, onChange, options, ...props }) => {
          ...
          return (
            ...
            >
              <SelectTrigger className="px-1.5 focus:ring-0 border-none shadow-none h-8 hover:bg-accent hover:text-accent-foreground py-0 font-medium text-sm gap-1 [&>span]:line-clamp-1 [&>svg]:h-4 [&>svg]:w-4 [&>svg]:opacity-50">
