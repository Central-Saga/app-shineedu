...
export function UpdateFeeDialog({ enrollmentId, currentStatus, trigger, onSuccess }: UpdateFeeDialogProps) {
    ...
    const handleUpdate = async () => {
        setLoading(true);
        try {
            const data = await enrollmentRepository.updateRegistrationFeeStatus(enrollmentId, { status });
